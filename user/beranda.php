...
// $sql = "SELECT pariwisata.*, kategori.nama_kategori 
//         FROM pariwisata
...
$sql = "SELECT pariwisata.*, kategori.nama_kategori 
        FROM pariwisata
        JOIN kategori ON pariwisata.id_kategori = kategori.id_kategori
        ORDER BY pariwisata.tanggal_input DESC 
        LIMIT 6";
$query = mysqli_query($koneksi, $sql);
...
<head>
  ...
  <title>Beranda | Hello Indonesia</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="carousel">
      <div class="carousel-track">
        <img src="gambar/beranda/carousel/carousel-1.jpeg" alt="Carousel 1">
        <img src="gambar/beranda/carousel/carousel-2.jpeg" alt="Carousel 2">
        <img src="gambar/beranda/carousel/carousel-3.jpeg" alt="Carousel 3">
        <img src="gambar/beranda/carousel/carousel-4.jpg" alt="Carousel 4">
        <img src="gambar/beranda/carousel/carousel-5.jpg" alt="Carousel 5">
        <img src="gambar/beranda/carousel/carousel-6.jpg" alt="Carousel 6">
        <img src="gambar/beranda/carousel/carousel-7.jpg" alt="Carousel 7">
        <img src="gambar/beranda/carousel/carousel-8.jpg" alt="Carousel 8">
        <!-- duplikat dari gambar diatas : -->
        <img src="gambar/beranda/carousel/carousel-1.jpeg" alt="Carousel 1">
        <img src="gambar/beranda/carousel/carousel-2.jpeg" alt="Carousel 2">
        <img src="gambar/beranda/carousel/carousel-3.jpeg" alt="Carousel 3">
        <img src="gambar/beranda/carousel/carousel-4.jpg" alt="Carousel 4">
    ...
    <section class="kategori-section">
      <div class="kategori-header">
        <button class="kategori-btn">KATEGORI PARIWISATA</button>
        <h2>Satu Negeri, <span>Sejuta Pesona</span></h2>
      </div>

      <div class="kategori-grid">
        <a href="kategori_kuliner.php" class="kategori-card">
          <img src="gambar/beranda/kategori/kuliner.jpg" alt="Kuliner">
          <div class="overlay"></div>
          <h3>Kuliner</h3>
          <p class="desc">Temukan berbagai destinasi <b>kuliner</b> di Bali <i class="fa-solid fa-circle-arrow-right"></i></p>
        </a>
        <a href="kategori_budaya.php" class="kategori-card">
          <img src="gambar/beranda/kategori/budaya.jpeg" alt="Budaya">
          <div class="overlay"></div>
          <h3>Budaya</h3>
          <p class="desc">Temukan berbagai destinasi <b>budaya</b> di Bali <i class="fa-solid fa-circle-arrow-right"></i></p>
        </a>
        <a href="kategori_sejarah.php" class="kategori-card">
          <img src="gambar/beranda/kategori/sejarah.jpeg" alt="Sejarah">
          <div class="overlay"></div>
          <h3>Sejarah</h3>
          <p class="desc">Temukan berbagai destinasi <b>sejarah</b> di Bali <i class="fa-solid fa-circle-arrow-right"></i></p>
        </a>
        <a href="kategori_pantai.php" class="kategori-card">
          <img src="gambar/beranda/kategori/pantai.jpeg" alt="Pantai">
          <div class="overlay"></div>
          <h3>Pantai</h3>
          <p class="desc">Temukan berbagai destinasi <b>pantai</b> di Bali <i class="fa-solid fa-circle-arrow-right"></i></p>
        </a>
        <a href="kategori_gunung.php" class="kategori-card">
          <img src="gambar/beranda/kategori/gunung.jpeg" alt="Gunung">
          <div class="overlay"></div>
          <h3>Gunung</h3>
          <p class="desc">Temukan berbagai destinasi <b>gunung</b> di Bali <i class="fa-solid fa-circle-arrow-right"></i></p>
        </a>
      </div>
    </section>
    ...
    <section class="populer-section">
      <div class="kategori-header">
        <button class="kategori-btn">PARIWISATA POPULER</button>
        <h2>Temukan Berbagai <span>Pariwisata Impian</span></h2>
      </div>
    </section>
    ...
    <div class="lihat-selengkapnya-container">
      <a href="pariwisata.php" class="btn-lihat-selengkapnya">
    ...
    <section class="why-hello-indonesia">
      ...
      <div class="stats-container">
        ...
        <div class="stat-item">
          ...
          <p class="stat-label">Destinasi Favorit</p>
        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      carouselTrack.style.animation = 'scroll-left 40s linear infinite';
