...
if ($kategori_aktif == 'all') {
    ...
    $sql2 = "SELECT p.*, k.nama_kategori 
            FROM pariwisata p 
            JOIN kategori k ON p.id_kategori = k.id_kategori 
            WHERE k.nama_kategori LIKE '%$kategori_aktif%' 
            ORDER BY p.rating_pariwisata DESC 
            LIMIT 12";
}
        ...
        <section class="populer-section">
            ...
            <div class="kategori-filter">
                <div class="filter-pills">
                    <button class="filter-pill <?= ($kategori_aktif == 'all') ? 'active' : '' ?>"
                        data-kategori="all" onclick="filterKategori('all')">
                        <span class="pill-icon">🌎</span>
                        <span class="pill-text">Semua</span>
                    </button>

                    <button class="filter-pill <?= ($kategori_aktif == 'Pantai') ? 'active' : '' ?>"
                        data-kategori="Pantai" onclick="filterKategori('Pantai')">
                        <span class="pill-icon">🏝️</span>
                        <span class="pill-text">Pantai</span>
                    </button>

                    <button class="filter-pill <?= ($kategori_aktif == 'Gunung') ? 'active' : '' ?>"
                        data-kategori="Gunung" onclick="filterKategori('Gunung')">
                        <span class="pill-icon">⛰️</span>
                        <span class="pill-text">Gunung</span>
                    </button>

                    <button class="filter-pill <?= ($kategori_aktif == 'Kuliner') ? 'active' : '' ?>"
                        data-kategori="Kuliner" onclick="filterKategori('Kuliner')">
                        <span class="pill-icon">🍜</span>
                        <span class="pill-text">Kuliner</span>
                    </button>

                    <button class="filter-pill <?= ($kategori_aktif == 'Sejarah') ? 'active' : '' ?>"
                        data-kategori="Sejarah" onclick="filterKategori('Sejarah')">
                        <span class="pill-icon">🏛️</span>
                        <span class="pill-text">Sejarah</span>
                    </button>

                    <button class="filter-pill <?= ($kategori_aktif == 'Budaya') ? 'active' : '' ?>"
                        data-kategori="Budaya" onclick="filterKategori('Budaya')">
                        <span class="pill-icon">🎭</span>
                        <span class="pill-text">Budaya</span>
                    </button>
                </div>
            </div>
    </div>
